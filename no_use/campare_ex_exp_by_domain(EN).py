...
def make_plot(scenarios, filename):
    ...
    # 전체 제목 (논문 스타일)
    fig.suptitle('Comparison of Persona-Based and CR2002 Experiments Across Domains', fontsize=18)

    # Figure 전체의 legend 추가 (오른쪽 상단, 전체 바깥)
    fig.legend(['CR2002 results', 'Persona'], loc='upper right', fontsize=15)
...
# 시나리오 1~3 저장
make_plot([1, 2, 3], 'EN_persona_vs_cr2002_scenarios_1_2_3.png')

# 시나리오 4~6 저장
make_plot([4, 5, 6], 'EN_persona_vs_cr2002_scenarios_4_5_6.png')

...
def make_comparison_plot(scenarios, filename):
    ...
    x_labels = ['Existing CR2002 Results', 'No-Persona Experimental Results']
    x = np.array([0, 1])
    width = 0.6
    ...
    fig.suptitle('Comparison of Existing CR2002 Results and No-Persona Experimental Results', fontsize=18)
    fig.tight_layout(rect=[0, 0, 1, 0.95])
    plt.savefig(filename, dpi=300)
    plt.close()

# 시나리오 1~3
make_comparison_plot([1, 2, 3], 'KR_cr2002_vs_nopersona_berk29_26_23.png')

# 시나리오 4~6
make_comparison_plot([4, 5, 6], 'KR_cr2002_vs_nopersona_berk15_barc8_barc2.png')
